...
module.exports = class EditorDiffExtender {
  ...
  destroy() {
    ...
    // remove diff-view css selector from editors for keybindings #73
    atom.views.getView(this._editor).classList.remove('diff-view');
  }
  ...
  _addOffsetDecoration(lineNumber, numberOfLines, blockPosition) {
    ...
    // Use markBufferPosition since lineNumber is a buffer line number from compute-diff.js
    // This ensures correct placement even with soft-wrap enabled
