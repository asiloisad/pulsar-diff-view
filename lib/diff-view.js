...
.diff-view-word-removed-custom .region {
  ...
  close() {
    ...
    if (this.diffView != null) {
      // Remove center line class from editors before cleanup (with safety checks)
      const editor1 =
      ...
      if (editor1 != null && !editor1.isDestroyed()) {
        try {
          ...
          /* editor view may be unavailable */
        }
      }
        ...
        if (projectRepo != null) {
          ...
          if (ref === "HEAD") {
            ...
            if (gitText != null) {
              ...
              atom.notifications.addWarning("Diff View", {
                detail: "No git HEAD version found for this file",
                dismissable: false,
                icon: "diff",
              });
              return;
  ...
  toggleCenterLine() {
    if (this.isEnabled && this.diffView != null) {
      ...
      if (editor1 != null || editor2 != null) {
        ...
        const isEnabled =
          (editorView1 != null && editorView1.classList.contains("show-center-line")) ||
